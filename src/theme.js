...
//    e.g."textLink.foreground" : themes({ l : scale.blue[5], d : scale.blue[2], dd : scale.blue[3], hc : scale.blue[3] }  ),
  ...
  const themes = (options) => options[theme], // Usage : themes({ l : "lightblue", d : "darkblue", dd : "royalblue", hc : "blue" })
        ...
        _u_ = themes({ l : _cO(`${hex(color.canvas.inset)}`,obj),
        ...
        _s_ = themes({ l : _cO(`${hex(color.canvas.inset)}`,obj),
                                lHC : _cO(`${hex(color.canvas.subtle)}`,obj),
                                lC : _cO(`${hex(color.canvas.subtle)}`,obj),
                                lT : _cO(`${hex(color.canvas.subtle)}`,obj),
      ...
      _bc_  = themes({ l : _cO(`${hex(color.canvas.inset)}`,obj),
                                  lHC : _cO(`${hex(color.canvas.subtle)}`,obj),
                                  lC : _cO(`${hex(color.canvas.subtle)}`,obj),
                                  lT : _cO(`${hex(color.canvas.subtle)}`,obj),
                                  d : _cO(`${hex(color.canvas.inset)}`,obj),
      ...
      _boc_ = themes({ l : _cO(`${hex(color.border.default)}`,obj),
    ...
    _e_=  themes({ l : _cO(`${_fuc_}${_x_[7]}`,obj),
                              lHC : _cO(`${_fuc_}${_x_[7]}`,obj),
                              lC : _cO(`${_fuc_}${_x_[7]}`,obj),
                              lT : _cO(`${_fuc_}${_x_[7]}`,obj),
                              d : _cO(`${_fuc_}${_x_[7]}`,obj),
                              dd : _cO(`${_fuc_}${_x_[7]}`,obj),
                              dhc : _cO(`${_fuc_}${_x_[7]}`,obj),
                              dc : _cO(`${_fuc_}${_x_[7]}`,obj),
                              dt : _cO(`${_fuc_}${_x_[7]}` ,obj)
                            }),
    _f_ =  themes({ l : _cO(`${_bc_}${_x_[7]}`,obj),
                              lHC : _cO(`${_bc_}${_x_[7]}`,obj),
                              lC : _cO(`${_bc_}${_x_[7]}`,obj),
                              lT : _cO(`${_bc_}${_x_[7]}`,obj),
                              d : _cO(`${_fc_}${_x_[7]}`,obj),
                              dd : _cO(`${_fc_}${_x_[7]}`,obj),
                              dhc : _cO(`${_fc_}${_x_[7]}`,obj),
                              dc : _cO(`${_fc_}${_x_[7]}`,obj),
                              dt : _cO(`${_fc_}${_x_[7]}` ,obj)
                            }),
    _g_=  themes({ l : _cO(`${_bc_}${_x_[3]}`,obj),
                              lHC : _cO(`${_bc_}${_x_[3]}`,obj),
                              lC : _cO(`${_bc_}${_x_[3]}`,obj),
                              lT : _cO(`${_bc_}${_x_[3]}`,obj),
                              d : _cO(`${_fc_}${_x_[3]}`,obj),
                              dd : _cO(`${_fc_}${_x_[3]}`,obj),
                              dhc : _cO(`${_fc_}${_x_[3]}`,obj),
                              dc : _cO(`${_fc_}${_x_[3]}`,obj),
                              dt : _cO(`${_fc_}${_x_[3]}`,obj)
                            }),
    _h_ =  themes({ l : _cO(`${_bc_}${_x_[8]}`,obj),
                              lHC : _cO(`${_bc_}${_x_[8]}`,obj),
                              lC : _cO(`${_bc_}${_x_[8]}`,obj),
                              lT : _cO(`${_bc_}${_x_[8]}`,obj),
                              d : _cO(`${_fc_}${_x_[8]}`,obj),
                              dd : _cO(`${_fc_}${_x_[8]}`,obj),
                              dhc : _cO(`${_fc_}${_x_[8]}`,obj),
                              dc : _cO(`${_fc_}${_x_[8]}`,obj),
                              dt : _cO(`${_fc_}${_x_[8]}`,obj)
                            }),

    _i_ = themes({ l : _cO(`${_fuc_}${_x_[0]}`,obj),
                              lHC : _cO(`${_fuc_}${_x_[0]}`,obj),
                              lC : _cO(`${_fuc_}${_x_[0]}`,obj),
                              lT : _cO(`${_fuc_}${_x_[0]}`,obj),
                              d : _cO(`${_boc_}${_x_[0]}`,obj),
                              dd : _cO(`${_boc_}${_x_[0]}`,obj),
                              dhc : _cO(`${_boc_}${_x_[0]}`,obj),
                              dc : _cO(`${_boc_}${_x_[0]}`,obj),
                              dt : _cO(`${_boc_}${_x_[0]}` ,obj)
                            }),

    _j_ =  themes({ l : _cO(`${_bc_}${_x_[6]}`,obj),
                              lHC : _cO(`${_bc_}${_x_[6]}`,obj),
                              lC : _cO(`${_bc_}${_x_[6]}`,obj),
                              lT : _cO(`${_bc_}${_x_[6]}`,obj),
                              d : _cO(`${_fc_}${_x_[6]}`,obj),
                              dd : _cO(`${_fc_}${_x_[6]}`,obj),
                              dhc : _cO(`${_fc_}${_x_[6]}`,obj),
                              dc : _cO(`${_fc_}${_x_[6]}`,obj),
                              dt : _cO(`${_fc_}${_x_[6]}`,obj)
                            }),
    _k_ =  themes({ l : _cO(`${_bc_}${_x_[4]}`,obj),
                              lHC : _cO(`${_bc_}${_x_[4]}`,obj),
                              lC : _cO(`${_bc_}${_x_[4]}`,obj),
                              lT : _cO(`${_bc_}${_x_[4]}`,obj),
                              d : _cO(`${_fc_}${_x_[4]}`,obj),
                              dd : _cO(`${_fc_}${_x_[4]}`,obj),
                              dhc : _cO(`${_fc_}${_x_[4]}`,obj),
                              dc : _cO(`${_fc_}${_x_[4]}`,obj),
                              dt : _cO(`${_fc_}${_x_[4]}`,obj)
                            }),
    _l_  =  themes({ l : _cO(`${_bc_}${_x_[5]}`,obj),
                              lHC : _cO(`${_bc_}${_x_[5]}`,obj),
                              lC : _cO(`${_bc_}${_x_[5]}`,obj),
                              lT : _cO(`${_bc_}${_x_[5]}`,obj),
                              d : _cO(`${_fc_}${_x_[5]}`,obj),
                              dd : _cO(`${_fc_}${_x_[5]}`,obj),
                              dhc : _cO(`${_fc_}${_x_[5]}`,obj),
                              dc : _cO(`${_fc_}${_x_[5]}`,obj),
                              dt : _cO(`${_fc_}${_x_[5]}`,obj)
                            }),
    _m_   =  themes({ l : _cO(`${_fuc_}${_x_[5]}`,obj),
                              lHC : _cO(`${_fuc_}${_x_[5]}`,obj),
                              lC : _cO(`${_fuc_}${_x_[5]}`,obj),
                              lT : _cO(`${_fuc_}${_x_[5]}`,obj),
                              d : _cO(`${_boc_}${_x_[5]}`,obj),
                              dd : _cO(`${_boc_}${_x_[5]}`,obj),
                              dhc : _cO(`${_boc_}${_x_[5]}`,obj),
                              dc : _cO(`${_boc_}${_x_[5]}`,obj),
                              dt : _cO(`${_boc_}${_x_[5]}`,obj)
                            }),
    _n_  = themes({ l : _cO(`${_bc_}${_x_[5]}`,obj),
                              lHC : _cO(`${_bc_}${_x_[5]}`,obj),
                              lC : _cO(`${_bc_}${_x_[5]}`,obj),
                              lT : _cO(`${_bc_}${_x_[5]}`,obj),
                              d : _cO(`${_fc_}${_x_[5]}`,obj),
    ...
    _o_ = themes({ l : _cO(`${_bc_}${_x_[7]}`,obj),
                              lHC : _cO(`${_bc_}${_x_[7]}`,obj),
                              lC : _cO(`${_bc_}${_x_[7]}`,obj),
                              lT : _cO(`${_bc_}${_x_[7]}`,obj),
                              d : _cO(`${_fc_}${_x_[7]}`,obj),
    ...
    _p_ = themes({ l : _cO(`${_fc_}${_x_[7]}`,obj),
                              lHC : _cO(`${_fc_}${_x_[7]}`,obj),
                              lC : _cO(`${_fc_}${_x_[7]}`,obj),
                              lT : _cO(`${_fc_}${_x_[7]}`,obj),
                              d : _cO(`${_bc_}${_x_[7]}`,obj),
                              dd : _cO(`${_bc_}${_x_[7]}`,obj),
                              dhc : _cO(`${_bc_}${_x_[7]}`,obj),
                              dc : _cO(`${_bc_}${_x_[7]}`,obj),
                              dt : _cO(`${_bc_}${_x_[7]}`,obj)
                            })
  return {
    name : name,
    colors : {
        ...
        "activityBar.activeFocusBorder" : _boc_,
        ...
        "activityBar.inactiveForeground" : _cO(`${_fc_}${_x_[5]}`,obj),
        ...
        "button.separator" : _cO(`${hex(color.success.muted)}${_x_[3]}`,obj),
      ...
      "keybindingLabel.foreground": _cO(`${_fc_}${_x_[5]}`,obj),
      ...
      "terminalCommandDecoration.defaultBackground" : _cO(`${_boc_}${_x_[5]}`,obj),
      ...
      "terminalCursor.foreground" : _fc_,
      ...
      "notebook.cellInsertionIndicator" : _cO(`${hex(color.success.muted)}${_x_[10]}`,obj),
        ...
        "notebookScrollbarSlider.activeBackground" : _cO(`${_fc_}${_x_[5]}`,obj),
     ...
     "settings.numberInputBorder" : _boc_,
      ...
      "settings.textInputForeground": _fc_,
        ...
        "notebook.cellHoverBackground" : _cO(`${_fuc_}${_x_[5]}`,obj),
