  ...
  _gT = ( { theme, name } ) =>
  {
    ...
    return {
      ...
      colors: {
        ...
        "focusBorder": this._cO( `${ _c.canvas.inset }${ _x_[ 5 ] }` ),
        "foreground": this._cO( `${ _c.fg.default }${ _x_[ 5 ] }` ),
        ...
        "editor.inlineValuesBackground": this._cO( `${ _c.success.emphasis }${ _x_[ 5 ] }` ),
        ...
        "editor.linkedEditingBackground": this._cO( `${ _c.attention.fg }${ _x_[ 2 ] }` ),
        "editor.rangeHighlightBackground": this._cO( `${ _c.success.emphasis }${ _x_[ 3 ] }` ),
        ...
        "editorCursor.foreground": this._cO( `${ _c.success.fg }${ _x_[ 10 ] }` ),
        ...
        "editorOverviewRuler.border": this._cO( `${ _c.success.emphasis }${ _x_[ 5 ] }` ),
        ...
        "editorOverviewRuler.findMatchForeground": this._cO( `${ _c.success.emphasis }${ _x_[ 5 ] }` ),
        ...
        "editorStickyScrollHover.background": this._cO( `${ _c.success.emphasis }${ _x_[ 3 ] }` ),
        ...
        "editorWidget.resizeBorder": this._cO( `${ _c.success.emphasis }${ _x_[ 5 ] }` ),
        ...
        "gitDecoration.addedResourceForeground": this._cO( `${ _c.success.emphasis }${ _x_[ 5 ] }` ),
        "gitDecoration.conflictingResourceForeground": this._cO( `${ _c.severe.emphasis }${ _x_[ 10 ] }` ),
        ...
        "keybindingLabel.border": this._cO( `${ _c.success.emphasis }${ _x_[ 5 ] }` ),
        ...
        "list.focusforeground": this._cO( `${ _c.fg.default }${ _x_[ 5 ] }` ),
        ...
        "list.hoverBackground": this._cO( `${ _c.success.emphasis }${ _x_[ 3 ] }` ),
        "list.hoverforeground": this._cO( `${ _c.fg.default }${ _x_[ 10 ] }` ),
        "list.inactiveFocusBackground": this._cO( `${ _c.neutral.emphasis }${ _x_[ 5 ] }` ),
        ...
        "tab.hoverBackground": this._cO( `${ _c.canvas.inset }${ _x_[ 10 ] }` ),
        "tab.hoverBorder": this._cO( `${ _c.attention.emphasis }${ _x_[ 5 ] }` ),
        "tab.hoverforeground": this._cO( `${ _c.fg.default }${ _x_[ 8 ] }` ),
        "tab.inactiveBackground": this._cO( `${ _c.canvas.inset }${ _x_[ 5 ] }` ),
        "tab.inactiveForeground": this._cO( `${ _c.fg.muted }${ _x_[ 5 ] }` ),
        "tab.inactiveModifiedBorder": this._cO( `${ _c.success.emphasis }${ _x_[ 5 ] }` ),
        "tab.lastPinnedborder": this._cO( `${ _c.border.muted }${ _x_[ 10 ] }` ),
        "tab.unfocusedActiveBackground": this._cO( `${ _c.success.emphasis }${ _x_[ 2 ] }` ),
        "tab.unfocusedActiveBorder": this._cO( `${ _c.success.emphasis }${ _x_[ 5 ] }` ),
        "tab.unfocusedActiveBorderTop": this._cO( `${ _c.success.emphasis }${ _x_[ 10 ] }` ),
        ...
        "tab.unfocusedHoverforeground": this._cO( `${ _c.fg.default }${ _x_[ 8 ] }` ),
        ...
        "settings.textInputForeground": this._cO( `${ _c.fg.default }${ _x_[ 5 ] }` ),
