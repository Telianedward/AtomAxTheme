...
const _l = require("./colors/light.json"),
_lHC = require("./colors/light_high_contrast.json"),
_lC = require("./colors/light_colorblind.json"),
_lT = require("./colors/light_tritanopia.json"),
_d = require("./colors/dark.json"),
_dD = require("./colors/dark_dimmed.json"),
_dHC  = require("./colors/dark_high_contrast.json"),
_dC = require("./colors/dark_colorblind.json"),
_dT = require("./colors/dark_tritanopia.json"),
