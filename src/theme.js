...
//    e.g."textLink.foreground" : themes({ l : scale.blue[5], d : scale.blue[2], dd : scale.blue[3], hc : scale.blue[3] }  ),
  ...
  return {
    ...
    colors : {
        ...
        "checkbox.border" :  _cO(`${hex(_boc_)}${_x_[5]}`,obj),
        ...
        "debugView.valueChangedHighlight" : _cO(`${hex(color.success.muted)}${_x_[5]}`,obj),
  
        "descriptionForeground" : _fc_,
  
        "diffEditor.border" : _boc_,
        "diffEditor.diagonalFill" : _cO(`${hex(_fc_)}${_x_[5]}`,obj),
      ...
      "editor.foldBackground" : _cO(`${hex(_boc_)}${_x_[6]}`,obj),
      "editor.foreground" : _fc_,
      "editor.hoverHighlightBackground" : _cO(`${hex(color.success.muted)}${_x_[9]}`,obj),
      "editor.inactiveSelectionBackground" : _cO(`${hex(_boc_)}${_x_[6]}`,obj),
      ...
      "editor.lineHighlightBorder" : _cO(`${hex(_fc_)}${_x_[1]}`,obj),
      ...
      "editor.stackFrameHighlightbackground" : _cO(`${hex(_fc_)}${_x_[5]}`,obj),
      ...
      "editor.wordHighlightBorder" : _cO(`${hex(_boc_)}${_x_[6]}`,obj),
      "editor.wordHighlightStrongBackground" : _cO(`${hex(color.success.muted)}${_x_[5]}`,obj),
      "editor.wordHighlightStrongBorder" : _cO(`${hex(_boc_)}${_x_[6]}`,obj),
      ...
      "editorIndentGuide.background" : _cO(`${hex(_fc_)}${_x_[0]}`,obj),
      ...
      "editorLineNumber.foreground" : _cO(`${hex(_fc_)}${_x_[5]}`,obj),
      ...
      "input.border" :  _boc_,
      "input.foreground": _cO(`${hex(_fc_)}${_x_[7]}`,obj),
      "input.placeholderForeground": _cO(`${hex(_fc_)}${_x_[7]}`,obj),
      "inputOption.activeBackground" : _cO(`${hex(_boc_)}${_x_[6]}`,obj),
      "inputOption.activeBorder" : _cO(`${hex(_boc_)}${_x_[6]}`,obj),
      "inputOption.activeForeground" : _cO(`${hex(_fc)}${_x_[5]}`,obj),
      "inputOption.hoverBackground": _cO(`${hex(_fc_)}${_x_[7]}`,obj),
      ...
      "minimap.foregroundOpacity" : _cO(`${hex(_fc)}${_x_[5]}`,obj),
      "minimap.selectionHighlight" : _cO(`${hex(color.success.fg)}${_x_[5]}`,obj),
      ...
      "minimapSlider.activeBackground" : _cO(`${hex(_fc_)}${_x_[5]}`,obj),
      ...
      "quickInputTitle.background" : _cO(`${hex(_fc_)}${_x_[5]}`,obj),
      ...
      "scrollbarSlider.hoverbackground" : _cO(`${hex(_fc_)}${_x_[5]}`,obj),
      ...
      "sideBar.dropBackground" : _cO(`${hex(_boc_)}${_x_[5]}`,obj),
      "sideBar.foreground" : _cO(`${hex(_fc)}${_x_[5]}`,obj),
      ...
      "statusBar.foreground" : _cO(`${hex(_fc_)}${_x_[5]}`,obj),
      ...
      "terminal.selectionForeground" : _cO(`${hex(_fc_)}${_x_[5]}`,obj),
      ...
      "textBlockQuote.border" : _cO(`${hex(_boc_)}${_x_[5]}`,obj),
  
      "textCodeBlock.background" : _cO(`${hex(_bc_)}${_x_[5]}`,obj),
      ...
      "titleBar.activeForeground": _cO(`${hex(_fc_)}${_x_[5]}`,obj),
      "titleBar.border" : _cO(`${hex(color.accent.fg)}${_x_[5]}`,obj),
      "titleBar.inactiveBackground" : _bc_,
      "titleBar.inactiveForeground" : _cO(`${hex(_fc)}${_x_[5]}`,obj),
  
      "toolbar.activeBackground" :  _cO(`${hex(_bc_)}${_x_[5]}`,obj),
