...
//    e.g."textLink.foreground" : themes({ l : scale.blue[5], d : scale.blue[2], dd : scale.blue[3], hc : scale.blue[3] }  ),
  ...
  const themes = (options) => options[theme]; // Usage : themes({ l : "lightblue", d : "darkblue", dd : "royalblue", hc : "blue" })
        ...
        // const color.canvas.overlay  = themes({l : color.canvas.overlay,
      ...
      // const  color.neutral.muted = themes({ l : color.neutral.muted,
      ...
      // const  color.fg.default = themes({ l : color.fg.default,
    ...
    //  const color.fg.muted  = themes({   l : color.fg.muted,
    //                             lHC : color.fg.muted,
    //                             lC : color.fg.muted,
    //                             lT : color.fg.muted,
    //                             d : color.fg.muted,
...
console.log(color.canvas.overlay, 'color.canvas.overlay')
console.log(color.canvas.subtle, 'color.canvas.subtle')
console.log(color.neutral.muted, 'color.neutral.muted')
console.log(color.neutral.muted, 'color.neutral.muted')
console.log(color.fg.default, 'color.fg.default')
...
console.log(color.fg.muted, '_color.fg.muted')
  return {
    ...
    colors : {
        ...
        "activityBar.border" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
        "activityBar.dropBorder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
        ...
        "checkbox.border" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
        ...
        "debugView.exceptionLabelBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
        "debugView.exceptionLabelforeground" : _cO(`${color.fg.default}${_x_[10]}`,obj),
        "debugView.stateLabelBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
        ...
        "diffEditor.border" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "dropdown.border" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      "dropdown.foreground" : _cO(`${color.fg.default}${_x_[10]}`,obj),
      "dropdown.listBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "editor.foldBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      "editor.foreground" : _cO(`${color.fg.default}${_x_[10]}`,obj),
      "editor.hoverHighlightBackground" : _cO(`${color.success.emphasis}${_x_[4]}`,obj),
      "editor.inactiveSelectionBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "editor.selectionBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "editor.selectionHighlightborder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      "editor.snippetFinalTabstopHighlightBackground" : _cO(`${color.canvas.overlay}${_x_[10]}`,obj),
      "editor.snippetFinalTabstopHighlightborder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      "editor.snippetTabstopHighlightBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      "editor.snippetTabstopHighlightborder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "editor.wordHighlightBorder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      "editor.wordHighlightStrongBackground" : _cO(`${color.success.emphasis}${_x_[5]}`,obj),
      "editor.wordHighlightStrongBorder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "editorBracketMatch.border" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "editorCommentsWidget.rangeActiveBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      "editorCommentsWidget.rangeActiveborder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      "editorCommentsWidget.rangeBackground" : _cO(`${color.success.emphasis}${_x_[10]}`,obj),
      "editorCommentsWidget.rangeborder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      "editorCommentsWidget.resolvedBorder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      "editorCommentsWidget.unresolvedBorder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "editorGroup.border" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "editorGroup.dropIntoPromptborder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "editorGroup.focusedEmptyBorder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      "editorGroupHeader.border" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "editorHoverWidget.border" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "editorInfo.background" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "editorInlayHint.parameterBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      "editorInlayHint.parameterForeground" : _cO(`${color.accent.fg}${_x_[10]}`,obj),
      "editorInlayHint.typeBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "editorPane.background" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "editorSuggestWidget.border" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "editorSuggestWidget.selectedBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "editorUnnecessaryCode.border" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "editorWidget.border" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "input.border" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      "input.foreground": _cO(`${color.fg.default}${_x_[10]}`,obj),
      "input.placeholderForeground": _cO(`${color.fg.default}${_x_[10]}`,obj),
      "inputOption.activeBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      "inputOption.activeBorder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "keybindingLabel.bottomBorder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "keybindingTable.rowsBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
  
      "list.activeSelectionBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "listFilterWidget.shadow" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
  
      "menu.background" : _cO(`${color.canvas.overlay}${_x_[10]}`,obj),
      "menu.border" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "menu.separatorBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "merge.border" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "mergeEditor.conflict.handledFocused.border" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "mergeEditor.conflict.unhandledUnfocused.border" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      "mergeEditor.conflictingLines.background" : _cO(`${color.danger.muted}${_x_[3]}`,obj),
      
      "minimap.background" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "notificationCenter.border" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "notificationToast.border" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
  
      "notifications.background" : _cO(`${color.canvas.overlay}${_x_[10]}`,obj),
      "notifications.border" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "panel.border" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      "panel.dropBorder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "panelSectionHeader.border" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "scm.providerborder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
  
      "scrollbar.shadow" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
  
      "scrollbarSlider.activeBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "searchEditor.findMatchBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      "searchEditor.findMatchBorder" : _cO(`${color.success.emphasis}${_x_[10]}`,obj),
      "searchEditor.textInputborder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
  
      "selection.background" : _cO(`${color.success.emphasis}${_x_[5]}`,obj),
  
      "sideBar.background" : _cO(`${color.canvas.overlay}${_x_[10]}`,obj),
      "sideBar.border" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      "sideBar.dropBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      "sideBar.foreground" : _cO(`${color.fg.default}${_x_[10]}`,obj),
      "sideBarSectionHeader.background" : _cO(`${color.canvas.overlay}${_x_[10]}`,obj),
      "sideBarSectionHeader.border" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "statusBar.border" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "statusBar.focusborder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "statusBarItem.focusborder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "tab.activeBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "tab.border" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      "tab.hoverBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "tab.lastPinnedborder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      "tab.unfocusedActiveBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "tab.unfocusedHoverBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "terminal.border" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "terminalCommandDecoration.defaultBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "testing.peekBorder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "textBlockQuote.border" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "tree.tableColumnsborder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      "tree.tableOddRowsBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
  
      "walkThrough.embeddedEditorBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "issues.closed" : _cO(`${color.danger.fg}${_x_[5]}`,obj),
        ...
        "notebook.cellBorderColor" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "notebook.cellInsertionIndicator" : _cO(`${color.success.emphasis}${_x_[10]}`,obj),
        "notebook.cellToolbarSeparator" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
        ...
        "notebook.focusedEditorborder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "notebookScrollbarSlider.hoverBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      ...
      "settings.checkboxBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
        "settings.checkboxBorder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      "settings.checkboxForeground" : _cO(`${color.fg.default}${_x_[10]}`,obj),
        "settings.dropdownBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
        "settings.dropdownBorder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
        "settings.dropdownForeground" : _cO(`${color.fg.default}${_x_[10]}`,obj),
        "settings.dropdownListBorder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
        ...
        "settings.headerBorder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
     ...
     "settings.numberInputBorder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      "settings.numberInputForeground": _cO(`${color.fg.default}${_x_[10]}`,obj),
      "settings.rowHoverBackground" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
        "settings.sashBorder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      "settings.textInputBackground" : _cO(`${color.canvas.overlay}${_x_[10]}`,obj),
        "settings.textInputBorder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
      "settings.textInputForeground": _cO(`${color.fg.default}${_x_[10]}`,obj),
        "statusBarItem.prominentHoverBackground" : _cO(`${color.neutral.muted}${_x_[3]}`,obj),
      ...
      "notebook.inactiveSelectedCellBorder" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
        "notebook.outputContainerBackgroundColor" :_cO(`${color.canvas.overlay}${_x_[10]}`,obj),
      "notebook.outputContainerBorderColor" : _cO(`${color.neutral.muted}${_x_[10]}`,obj),
