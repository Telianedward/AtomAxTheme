...
console.log(color.fg.muted, '_color.fg.muted')
  return {
    name : name,
    colors : {
        "activityBar.activeBackground" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
        ...
        "activityBar.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
        ...
        "activityBar.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
        ...
        "activityBar.dropBorder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
        ...
        "activityBar.inactiveForeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
        ...
        "activityBarBadge.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
        ...
        "badge.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
        ...
        "banner.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
        ...
        "breadcrumb.activeSelectionforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
        ...
        "breadcrumb.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
        ...
        "breadcrumb.focusforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
        ...
        "breadcrumb.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
        ...
        "breadcrumbPicker.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
        ...
        "button.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
        ...
        "button.secondaryforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
        ...
        "charts.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
        ...
        "charts.lines" : _cO(`${themes({   l : color.fg.muted,
                                lHC : color.fg.muted,
                                lC : color.fg.muted,
                                lT : color.fg.muted,
                                d : color.fg.muted,
        ...
        "checkbox.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
        ...
        "checkbox.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
        ...
        "checkbox.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
        ...
        "commandCenter.activeforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
        ...
        "commandCenter.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
        ...
        "commandCenter.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
        ...
        "commandCenter.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
        ...
        "contrastActiveborder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
        ...
        "contrastBorder" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
        ...
        "debugExceptionWidget.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
        ...
        "debugExceptionWidget.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
        ...
        "debugView.exceptionLabelBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
        ...
        "debugView.exceptionLabelforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
        ...
        "debugView.stateLabelBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
        ...
        "debugView.stateLabelforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
        ...
        "descriptionForeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
        ...
        "diffEditor.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
        ...
        "diffEditor.diagonalFill" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "disabledForeground" : _cO(`${themes({   l : color.fg.muted,
                                lHC : color.fg.muted,
                                lC : color.fg.muted,
                                lT : color.fg.muted,
                                d : color.fg.muted,
      ...
      "dropdown.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "dropdown.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "dropdown.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "dropdown.listBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editor.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "editor.foldBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editor.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "editor.inactiveSelectionBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editor.inlineValuesforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "editor.selectionBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editor.selectionHighlightborder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editor.snippetFinalTabstopHighlightBackground" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "editor.snippetFinalTabstopHighlightborder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editor.snippetTabstopHighlightBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editor.snippetTabstopHighlightborder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editor.stackFrameHighlightbackground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "editor.wordHighlightBorder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editor.wordHighlightStrongBorder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editorBracketMatch.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "editorBracketMatch.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editorCodeLens.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "editorCommentsWidget.rangeActiveBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editorCommentsWidget.rangeActiveborder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editorCommentsWidget.rangeborder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editorCommentsWidget.resolvedBorder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editorCommentsWidget.unresolvedBorder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editorCursor.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "editorCursor.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "editorGroup.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editorGroup.dropIntoPromptBackground" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "editorGroup.dropIntoPromptborder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editorGroup.dropIntoPromptforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "editorGroup.emptyBackground" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "editorGroup.focusedEmptyBorder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editorGroupHeader.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editorGroupHeader.noTabsBackground" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "editorGroupHeader.tabsBackground" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "editorGutter.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "editorGutter.commentRangeforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "editorGutter.foldingControlforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "editorHoverWidget.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "editorHoverWidget.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editorHoverWidget.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "editorIndentGuide.background" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "editorInfo.background" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editorInlayHint.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "editorInlayHint.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "editorInlayHint.parameterBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editorInlayHint.typeBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editorLineNumber.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "editorMarkerNavigation.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "editorMarkerNavigationInfo.headerBackground" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "editorOverviewRuler.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "editorOverviewRuler.commonContentforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "editorOverviewRuler.incomingContentforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "editorPane.background" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editorStickyScroll.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "editorStickyScrollHover.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "editorSuggestWidget.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "editorSuggestWidget.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editorSuggestWidget.focusHighlightforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "editorSuggestWidget.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "editorSuggestWidget.highlightforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "editorSuggestWidget.selectedBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editorSuggestWidget.selectedforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "editorSuggestWidget.selectedIconforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "editorUnnecessaryCode.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editorWidget.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "editorWidget.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "editorWidget.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "extensionBadge.remoteforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "extensionButton.prominentforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "focusBorder" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "gitDecoration.renamedResourceforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "gitDecoration.submoduleResourceForeground" : _cO(`${themes({   l : color.fg.muted,
                                lHC : color.fg.muted,
                                lC : color.fg.muted,
                                lT : color.fg.muted,
                                d : color.fg.muted,
      ...
      "gitDecoration.untrackedResourceforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "icon.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "input.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "input.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "input.foreground": _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "input.placeholderForeground": _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "inputOption.activeBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "inputOption.activeBorder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "inputOption.activeForeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "inputOption.hoverBackground": _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "keybindingLabel.bottomBorder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "keybindingLabel.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "keybindingLabel.foreground": _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "keybindingTable.headerBackground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "keybindingTable.rowsBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "list.activeSelectionBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "list.activeSelectionforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "list.focusforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "list.highlightforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "list.hoverforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "list.inactiveSelectionforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "listFilterWidget.shadow" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "menu.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "menu.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "menu.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "menu.selectionforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "menu.separatorBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "menubar.selectionForeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "merge.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "mergeEditor.change.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "mergeEditor.change.word.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "mergeEditor.conflict.handledFocused.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "mergeEditor.conflict.unhandledUnfocused.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "minimap.background" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "minimap.foregroundOpacity" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "minimapSlider.activeBackground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "notificationCenter.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "notificationCenterHeader.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "notificationCenterHeader.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "notificationToast.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "notifications.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "notifications.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "notifications.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "panel.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "panel.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "panel.dropBorder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "panelSection.dropBackground" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "panelSectionHeader.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "panelSectionHeader.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "panelSectionHeader.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "panelTitle.activeforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "panelTitle.inactiveforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "peekViewEditor.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "peekViewEditorGutter.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "peekViewResult.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "peekViewResult.fileforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "peekViewResult.lineforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "pickerGroup.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "quickInput.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "quickInput.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "quickInputList.focusforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "quickInputTitle.background" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "scm.providerborder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "scrollbar.shadow" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "scrollbarSlider.activeBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "scrollbarSlider.hoverbackground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "searchEditor.findMatchBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "searchEditor.textInputborder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "sideBar.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "sideBar.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "sideBar.dropBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "sideBar.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "sideBarSectionHeader.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "sideBarSectionHeader.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "sideBarSectionHeader.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "sideBarTitle.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "statusBar.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "statusBar.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "statusBar.debuggingforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "statusBar.focusborder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "statusBar.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "statusBar.noFolderforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "statusBarItem.activeBackground" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "statusBarItem.compactHoverBackground" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "statusBarItem.focusborder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "statusBarItem.prominentBackground" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "statusBarItem.remoteforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "statusBarItem.settingsProfilesBackground" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "statusBarItem.settingsProfilesforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "symbolIcon.propertyforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "symbolIcon.referenceForeground" : _cO(`${themes({   l : color.fg.muted,
                                lHC : color.fg.muted,
                                lC : color.fg.muted,
                                lT : color.fg.muted,
                                d : color.fg.muted,
      ...
      "tab.activeBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "tab.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "tab.hoverBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "tab.hoverforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "tab.inactiveBackground" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "tab.inactiveForeground" : _cO(`${themes({   l : color.fg.muted,
                                lHC : color.fg.muted,
                                lC : color.fg.muted,
                                lT : color.fg.muted,
                                d : color.fg.muted,
      ...
      "tab.lastPinnedborder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "tab.unfocusedActiveBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "tab.unfocusedHoverBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "tab.unfocusedHoverforeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "tab.unfocusedInactiveBackground" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "tab.unfocusedInactiveForeground" : _cO(`${themes({   l : color.fg.muted,
                                lHC : color.fg.muted,
                                lC : color.fg.muted,
                                lT : color.fg.muted,
                                d : color.fg.muted,
      ...
      "terminal.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "terminal.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "terminal.selectionForeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "terminalCommandDecoration.defaultBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "testing.peekBorder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "textBlockQuote.border" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "textCodeBlock.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "textPreformat.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "textSeparator.foreground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "titleBar.activeBackground" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "titleBar.activeForeground": _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "titleBar.inactiveBackground" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "titleBar.inactiveForeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "toolbar.activeBackground" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "toolbar.hoverBackground" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "toolbar.hoverOutline" : _cO(`${themes({   l : color.fg.muted,
                                lHC : color.fg.muted,
                                lC : color.fg.muted,
                                lT : color.fg.muted,
                                d : color.fg.muted,
      ...
      "tree.tableColumnsborder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "tree.tableOddRowsBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "walkThrough.embeddedEditorBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "welcomePage.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "welcomePage.progress.background" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "welcomePage.tileBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "welcomePage.tileHoverBackground" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "welcomePage.tileShadow" : _cO(`${themes({   l : color.fg.muted,
                                lHC : color.fg.muted,
                                lC : color.fg.muted,
                                lT : color.fg.muted,
                                d : color.fg.muted,
      ...
      "widget.shadow" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "window.activeBorder" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "window.inactiveBorder" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "debugIcon.breakpointStackframeForeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "issues.closed" : _cO(`${color.danger.fg}${_x_[5]}`,obj),
        "issues.newIssueDecoration" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
        ...
        "notebook.cellBorderColor" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "notebook.cellEditorBackground" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "notebook.cellInsertionIndicator" : _cO(`${color.success.emphasis}${_x_[10]}`,obj),
        "notebook.cellToolbarSeparator" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
        ...
        "notebook.editorBackground" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
        ...
        "notebook.focusedEditorborder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
        ...
        "notebookScrollbarSlider.activeBackground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "notebookScrollbarSlider.hoverBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "settings.checkboxBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
        ...
        "settings.checkboxBorder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "settings.checkboxForeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
        ...
        "settings.dropdownBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
        ...
        "settings.dropdownBorder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
        ...
        "settings.dropdownForeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
        ...
        "settings.dropdownListBorder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
        ...
        "settings.headerBorder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
        ...
        "settings.headerForeground" : _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
        ...
        "settings.numberInputBackground" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
     ...
     "settings.numberInputBorder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "settings.numberInputForeground": _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
      ...
      "settings.rowHoverBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
        ...
        "settings.sashBorder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "settings.textInputBackground" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
        ...
        "settings.textInputBorder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
      ...
      "settings.textInputForeground": _cO(`${themes({ l : color.fg.default,
                                lHC : color.fg.default,
                                lC : color.fg.default,
                                lT : color.fg.default,
                                d : color.fg.default,
        ...
        "statusBarItem.prominentHoverBackground" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
        ...
        "notebook.cellHoverBackground" : _cO(`${themes({   l : color.fg.muted,
                                lHC : color.fg.muted,
                                lC : color.fg.muted,
                                lT : color.fg.muted,
                                d : color.fg.muted,
      ...
      "notebook.inactiveSelectedCellBorder" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
        ...
        "notebook.outputContainerBackgroundColor" :_cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
      ...
      "notebook.outputContainerBorderColor" : _cO(`${themes({ l : color.neutral.muted,
                                lHC : color.neutral.muted,
                                lC : color.neutral.muted,
                                lT : color.neutral.muted,
                                d : color.border.muted,
        ...
        "quickInput.list.focusBackground" : _cO(`${themes({      l : color.canvas.subtle,
                                  lHC : color.canvas.subtle,
                                  lC : color.canvas.subtle,
                                  lT : color.canvas.subtle,
                                  d : color.canvas.overlay,
